...
public static class VacationErrors
{
    ...
    public static readonly Error InvalidReturnTarget = new("Vacation.InvalidReturnTarget", "Select an earlier approval stage in this vacation request workflow.", StatusCodes.Status400BadRequest);
    ...
    public static readonly Error HrNotReady = new("Vacation.HrNotReady", "HR work is available only after all required approval stages are approved.", StatusCodes.Status409Conflict);
